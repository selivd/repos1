...
$$
\begin{aligned}
S(t_0,t_1)&=\intd{t_0}{t_1}\phi(w)\tilde{S}(w,t_1)\,dw=\int\limits^{t_0}_{t_1}\phi(w)\left\{  G^T_2(w,t)G^T_1(t_0,w)\ell(w) + \mu(w) G_2^T(w,t)c \right\}\,dw, \\
...
$$
\max_{x\in\mathcal{X}}\intd{t_0}{t_1}\ts{\ell,x}ds=\max_{x\in\mathcal{X}}\intd{t_1}{t_0}\ts{-\ell,x}ds=\intd{t_1}{t_0}\rho(-\ell\mid\mathcal{X})ds,\;\mathcal{X}\in\mbox{Comp}(\mathbb{H}).
$$
